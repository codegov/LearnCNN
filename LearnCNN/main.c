...
int read_lables()
{
    FILE *fp = fopen("/Users/javalong/Desktop/Github/LearnCNN/LearnCNN/train-labels-idx1-ubyte", "r");
    if (NULL == fp)
    {
        return -1;
    }
...
int read_images()
{
    FILE *fp = fopen("/Users/javalong/Desktop/Github/LearnCNN/LearnCNN/train-images-idx3-ubyte", "r");
    if (NULL == fp)
    {
        return -1;
    }
